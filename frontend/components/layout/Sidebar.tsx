...
import {
  ...
  BookOpen, PackageCheck, CalendarCheck2, ClipboardCheck,
  type LucideIcon,
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Review Return',  href: '/(admin)/return-review',          Icon: ClipboardCheck,  roles: ['ADMIN', 'INVENTORI'],           group: 'Operasional' },
  ...
  // Laporan — ADMIN & SHAREHOLDER
  { label: 'Lap. Penjualan', href: '/(admin)/laporan',                Icon: TrendingUp,      roles: ['ADMIN'],                        group: 'Laporan' },
  // Shareholder view
  ...
  { label: 'Laporan',        href: '/(shareholder)/laporan',          Icon: TrendingUp,      roles: ['SHAREHOLDER'],                  group: 'Laporan' },
  // Driver
