...
def upgrade() -> None:
    ...
    op.alter_column('purchase_orders', 'metode_bayar',
               existing_type=sa.VARCHAR(length=20),
               type_=sa.Enum('tunai', 'tempo', 'transfer', name='metodebayar'),
               existing_nullable=False,
               existing_server_default=sa.text("'tunai'::character varying"))
    op.alter_column('purchase_orders', 'status',
               existing_type=sa.VARCHAR(length=20),
               type_=sa.Enum('draft', 'diterima', 'lunas', 'jatuh_tempo', name='statuspo'),
               existing_nullable=False,
...
def downgrade() -> None:
    ...
    op.alter_column('purchase_orders', 'total_amount',
               ...
               nullable=True)
    op.alter_column('purchase_orders', 'status',
               existing_type=sa.Enum('draft', 'diterima', 'lunas', 'jatuh_tempo', name='statuspo'),
               type_=sa.VARCHAR(length=20),
               existing_nullable=False,
               existing_server_default=sa.text("'draft'::character varying"))
    op.alter_column('purchase_orders', 'metode_bayar',
               existing_type=sa.Enum('tunai', 'tempo', 'transfer', name='metodebayar'),
               type_=sa.VARCHAR(length=20),
               existing_nullable=False,
               existing_server_default=sa.text("'tunai'::character varying"))
